...
async function main() {
  ...
  const menuItems = await Promise.all([
    // Starters
    prisma.menuItem.create({ data: { categoryId: categories[0].id, name: 'Caesar Salad', description: 'Crisp romaine, parmesan, croutons, anchovy dressing', price: 14, cost: 3.5, type: 'APPETIZER', station: 'KITCHEN', prepTime: 8, isPopular: true, allergies: 'dairy,fish,gluten', imageUrl: 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[0].id, name: 'Bruschetta', description: 'Toasted sourdough, vine tomatoes, fresh basil, balsamic glaze', price: 12, cost: 2.5, type: 'APPETIZER', station: 'KITCHEN', prepTime: 7, allergies: 'gluten', imageUrl: 'https://images.unsplash.com/photo-1572656631137-7935297eff55?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[0].id, name: 'Garlic Prawns', description: 'Sautéed prawns in garlic butter with lemon and herbs', price: 18, cost: 7, type: 'APPETIZER', station: 'KITCHEN', prepTime: 10, allergies: 'shellfish,dairy', imageUrl: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[0].id, name: 'Soup of the Day', description: 'Freshly prepared daily - ask your server', price: 10, cost: 2, type: 'APPETIZER', station: 'KITCHEN', prepTime: 5, imageUrl: 'https://images.unsplash.com/photo-1547592165-e1d17fed6005?w=600&auto=format&fit=crop&q=60' } }),
    // Mains
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Grilled Ribeye', description: '12oz prime ribeye, truffle mash, seasonal vegetables, red wine jus', price: 42, cost: 16, type: 'FOOD', station: 'KITCHEN', prepTime: 25, isPopular: true, allergies: 'dairy', imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Pan-Seared Salmon', description: 'Atlantic salmon, dill cream sauce, roasted potatoes, asparagus', price: 32, cost: 11, type: 'FOOD', station: 'KITCHEN', prepTime: 18, isPopular: true, allergies: 'dairy,fish', imageUrl: 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Chicken Marsala', description: 'Breaded chicken, marsala wine sauce, mushrooms, linguine', price: 26, cost: 7, type: 'FOOD', station: 'KITCHEN', prepTime: 20, allergies: 'gluten,dairy', imageUrl: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Spaghetti Carbonara', description: 'Guanciale, pecorino, egg yolk, black pepper', price: 22, cost: 5, type: 'FOOD', station: 'KITCHEN', prepTime: 15, isPopular: true, allergies: 'dairy,eggs,gluten', imageUrl: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Veggie Risotto', description: 'Arborio rice, seasonal vegetables, parmesan, white wine', price: 20, cost: 4.5, type: 'FOOD', station: 'KITCHEN', prepTime: 22, allergies: 'dairy', imageUrl: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[1].id, name: 'Fish & Chips', description: 'Beer-battered cod, hand-cut chips, mushy peas, tartar sauce', price: 24, cost: 6, type: 'FOOD', station: 'KITCHEN', prepTime: 15, allergies: 'fish,gluten', imageUrl: 'https://images.unsplash.com/photo-1579619173026-b3d2222b429d?w=600&auto=format&fit=crop&q=60' } }),
    // Desserts
    prisma.menuItem.create({ data: { categoryId: categories[2].id, name: 'Chocolate Lava Cake', description: 'Warm dark chocolate fondant, vanilla ice cream', price: 14, cost: 3.5, type: 'DESSERT', station: 'KITCHEN', prepTime: 12, isPopular: true, allergies: 'dairy,eggs,gluten', imageUrl: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[2].id, name: 'Tiramisu', description: 'Classic Italian tiramisu with espresso and mascarpone', price: 12, cost: 3, type: 'DESSERT', station: 'KITCHEN', prepTime: 5, allergies: 'dairy,eggs,gluten', imageUrl: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[2].id, name: 'Crème Brûlée', description: 'Vanilla bean custard with caramelized sugar top', price: 11, cost: 2, type: 'DESSERT', station: 'KITCHEN', prepTime: 5, allergies: 'dairy,eggs', imageUrl: 'https://images.unsplash.com/photo-1470324161839-ce2bb6fa6bc3?w=600&auto=format&fit=crop&q=60' } }),
    // Cocktails
    prisma.menuItem.create({ data: { categoryId: categories[3].id, name: 'Classic Mojito', description: 'White rum, fresh mint, lime, sugar, soda water', price: 14, cost: 3, type: 'DRINK', station: 'BAR', prepTime: 3, isPopular: true, imageUrl: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[3].id, name: 'Espresso Martini', description: 'Vodka, coffee liqueur, fresh espresso', price: 16, cost: 4, type: 'DRINK', station: 'BAR', prepTime: 3, isPopular: true, imageUrl: 'https://images.unsplash.com/photo-1545696911-c4379e7ac1f4?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[3].id, name: 'Old Fashioned', description: 'Bourbon, bitters, sugar, orange peel', price: 15, cost: 4.5, type: 'DRINK', station: 'BAR', prepTime: 2, imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[3].id, name: 'Gin & Tonic', description: 'Premium gin, tonic water, cucumber, juniper', price: 13, cost: 3, type: 'DRINK', station: 'BAR', prepTime: 2, imageUrl: 'https://images.unsplash.com/photo-1524156868115-e696b44983db?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[3].id, name: 'Margarita', description: 'Tequila, triple sec, lime juice, salt rim', price: 14, cost: 3.5, type: 'DRINK', station: 'BAR', prepTime: 3, imageUrl: 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=600&auto=format&fit=crop&q=60' } }),
    // Beer & Wine
    prisma.menuItem.create({ data: { categoryId: categories[4].id, name: 'House Red Wine', description: 'Cabernet Sauvignon, Napa Valley', price: 12, cost: 4, type: 'DRINK', station: 'BAR', prepTime: 1, imageUrl: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[4].id, name: 'House White Wine', description: 'Chardonnay, Sonoma Coast', price: 12, cost: 4, type: 'DRINK', station: 'BAR', prepTime: 1, imageUrl: 'https://images.unsplash.com/photo-1569919650476-f54aea20054f?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[4].id, name: 'Craft IPA', description: 'Local brewery rotating tap', price: 9, cost: 3, type: 'DRINK', station: 'BAR', prepTime: 1, imageUrl: 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[4].id, name: 'Lager', description: 'Premium lager on tap', price: 7, cost: 2, type: 'DRINK', station: 'BAR', prepTime: 1, imageUrl: 'https://images.unsplash.com/photo-1566633806327-68e152aaf26d?w=600&auto=format&fit=crop&q=60' } }),
    // Non-Alcoholic
    prisma.menuItem.create({ data: { categoryId: categories[5].id, name: 'Espresso', description: 'Double shot, locally roasted', price: 5, cost: 1, type: 'DRINK', station: 'BAR', prepTime: 2, imageUrl: 'https://images.unsplash.com/photo-151097252790b-af4f982c78a2?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[5].id, name: 'Fresh Lemonade', description: 'House-made with fresh lemons and mint', price: 6, cost: 1, type: 'DRINK', station: 'BAR', prepTime: 3, imageUrl: 'https://images.unsplash.com/photo-1534353436294-0dbd4bdac845?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[5].id, name: 'Sparkling Water', description: 'San Pellegrino 750ml', price: 5, cost: 1.5, type: 'DRINK', station: 'BAR', prepTime: 1, imageUrl: 'https://images.unsplash.com/photo-1608885898957-a599fb1b4641?w=600&auto=format&fit=crop&q=60' } }),
    // Sides
    prisma.menuItem.create({ data: { categoryId: categories[6].id, name: 'Truffle Fries', description: 'Hand-cut, truffle oil, parmesan, herbs', price: 10, cost: 2.5, type: 'SIDE', station: 'KITCHEN', prepTime: 10, isPopular: true, allergies: 'dairy', imageUrl: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[6].id, name: 'Seasonal Vegetables', description: 'Grilled seasonal selection', price: 8, cost: 2, type: 'SIDE', station: 'KITCHEN', prepTime: 8, imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[6].id, name: 'Garlic Bread', description: 'Sourdough, roasted garlic butter, herbs', price: 7, cost: 1.5, type: 'SIDE', station: 'KITCHEN', prepTime: 6, allergies: 'gluten,dairy', imageUrl: 'https://images.unsplash.com/photo-1573140247632-f8fd74997d5c?w=600&auto=format&fit=crop&q=60' } }),
    prisma.menuItem.create({ data: { categoryId: categories[6].id, name: 'Mashed Potatoes', description: 'Creamy butter mash with chives', price: 7, cost: 1.5, type: 'SIDE', station: 'KITCHEN', prepTime: 8, allergies: 'dairy', imageUrl: 'https://images.unsplash.com/photo-1576402187878-974f70c890a5?w=600&auto=format&fit=crop&q=60' } }),
